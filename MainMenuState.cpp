...
void MainMenuState::initButtons()
{
    ...
    this->buttons["GAME_STATE"] = new gui::Button(topButton[0], topButton[1]+topButton[3]*nth_btn+distance*nth_btn, topButton[2], topButton[3], 
        &this->font, "New Game", 
        28, 33, 33, 
    ...
    nth_btn++;
    this->buttons["SETTINGS_STATE"] = new gui::Button(topButton[0], topButton[1]+topButton[3]*nth_btn+distance*nth_btn, topButton[2], topButton[3], 
        &this->font, "Settings", 
        28, 33, 33, 
        sf::Color(0, 0, 0, 255), sf::Color(0, 0, 0, 255), sf::Color(0, 0, 0, 255),
        sf::Color(100, 100, 100, 0), sf::Color(150, 150, 150, 50), sf::Color(150, 150, 150, 200));
    nth_btn++;
    this->buttons["EDITOR_STATE"] = new gui::Button(topButton[0], topButton[1]+topButton[3]*nth_btn+distance*nth_btn, topButton[2], topButton[3], 
        &this->font, "Editor", 
        28, 33, 33, 
        sf::Color(0, 0, 0, 255), sf::Color(0, 0, 0, 255), sf::Color(0, 0, 0, 255), 
        sf::Color(100, 100, 100, 0), sf::Color(150, 150, 150, 50), sf::Color(150, 150, 150, 200));
